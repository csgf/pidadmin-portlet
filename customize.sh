...
GRID_ENGINE_HOME=/opt/liferay/glassfish-3.1.2/domains/domain1/lib

# Author' information
# Used to fill-up portlet' licence information
AUTH_EMAIL='manuel.rodriguez@ciemat.es'
AUTH_NAME='Manuel Rodriguez-Pascual'
AUTH_INSTITUTE='CIEMAT'
...
#init_pxRobotId
INI_1_ROBOTID=332576f78a4fe70a52048043e90cd11f
...
#
INFO_INFRA=`mktemp /tmp/temp.XXXX `
INI_INFRASTRUCTURES=`mktemp /tmp/temp.XXXX` 
...
#
NEW_PILOT=`mktemp /tmp/temp.XXXX`
