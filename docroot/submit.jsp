...
<tr>
  <td valign="top">  <td>
  Your PID has been <b>successfully</b> created:<br>
  </td>
</tr>
<tr>
...
<input type="submit" value="Create a new PID"></form></td>
<td>Press the <b>Create a new PID</b> button to go back and create a new PID</td>
</tr>
</table>
